package me.violinsolo.boman.test;
...
public class BlankFragment extends BaseFragment<FragmentBlankBinding> {
     ...
     */
    @Override
    protected FragmentBlankBinding onBind(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent) {
        return FragmentBlankBinding.inflate(inflater, parent, false);
    }
