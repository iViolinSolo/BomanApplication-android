...
import me.violinsolo.boman.model.base.DeviceInfo;
 ...
 */
public class ThermometerDeviceInfo extends DeviceInfo {
    private String mac; //MAC地址 6个字节
    private String version; //下位机程序版本号ASCII码翻译 5个字节
    private byte deviceType; //设备类型：0x01为额温计 1个字节
    private byte bluetoothType; //蓝牙协议类型：0x02为4.2   0x10为5.0   0x11为5.1   0x12为5.2   1个字节
    private byte temperatureUnit; //摄氏度华氏度设置 1个字节
